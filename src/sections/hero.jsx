    ...
    <section id="inicio" className="hero-section">
      <div className="hero-content">
        ...
        <div className="hero-buttons">
          <a href="https://github.com/tu-usuario" target="_blank" rel="noreferrer" className="btn-social">
          ...
          <a href="https://linkedin.com/in/tu-usuario" target="_blank" rel="noreferrer" className="btn-social">
          ...
          <a href="/tu-cv.pdf" target="_blank" rel="noreferrer" className="btn-social btn-cv">
